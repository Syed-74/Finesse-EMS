            ...
            {!todayRecord ? (
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-xl font-bold text-lg shadow-lg shadow-blue-200 transition-all active:scale-95 ${loading || !location || !capturedImage ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 text-white'
                    }`}
                >
